...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	>=dev-python/beautifulsoup-3.0.5[${PYTHON_USEDEP}]
...
src_prepare() {
	...
	# disable_python_version_check: calibre works with python 3, so remove the python 2 constraint
	eapply \
		"${FILESDIR}/${PN}-2.9.0-no_updates_dialog.patch" \
		"${FILESDIR}/${PN}-disable_plugins.patch" \
		"${FILESDIR}/${PN}-4.8.0-disable_python_version_check.patch"
